...
#define ST25R3916_SPACE_B                                   0x40U
#ifdef ST25R3916B
#define ST25R3916_SPACE_B_REG_LEN                           24U
#else
#define ST25R3916_SPACE_B_REG_LEN                           16U
#endif

#define ST25R3916_FIFO_STATUS_LEN                           2

#define ST25R3916_PTM_A_LEN                                 15U
#define ST25R3916_PTM_B_LEN                                 0U
#define ST25R3916_PTM_F_LEN                                 21U
#define ST25R3916_PTM_TSN_LEN                               12U

#define ST25R3916_PTM_LEN                                   (ST25R3916_PTM_A_LEN + ST25R3916_PTM_B_LEN + ST25R3916_PTM_F_LEN + ST25R3916_PTM_TSN_LEN)

#define ST25R3916_REG_IO_CONF1                              0x00U
#define ST25R3916_REG_IO_CONF2                              0x01U

#define ST25R3916_REG_OP_CONTROL                            0x02U
#define ST25R3916_REG_MODE                                  0x03U
#define ST25R3916_REG_BIT_RATE                              0x04U

#define ST25R3916_REG_ISO14443A_NFC                         0x05U
#define ST25R3916_REG_EMD_SUP_CONF       (ST25R3916_SPACE_B|0x05U)
#define ST25R3916_REG_ISO14443B_1                           0x06U
#define ST25R3916_REG_SUBC_START_TIME    (ST25R3916_SPACE_B|0x06U)
#define ST25R3916_REG_ISO14443B_2                           0x07U
#define ST25R3916_REG_PASSIVE_TARGET                        0x08U
#define ST25R3916_REG_STREAM_MODE                           0x09U
#define ST25R3916_REG_AUX                                   0x0AU

#define ST25R3916_REG_RX_CONF1                              0x0BU
#define ST25R3916_REG_RX_CONF2                              0x0CU
#define ST25R3916_REG_RX_CONF3                              0x0DU
#define ST25R3916_REG_RX_CONF4                              0x0EU
#define ST25R3916_REG_P2P_RX_CONF        (ST25R3916_SPACE_B|0x0BU)
#define ST25R3916_REG_CORR_CONF1         (ST25R3916_SPACE_B|0x0CU)
#define ST25R3916_REG_CORR_CONF2         (ST25R3916_SPACE_B|0x0DU)

#define ST25R3916_REG_MASK_RX_TIMER                         0x0FU
#define ST25R3916_REG_NO_RESPONSE_TIMER1                    0x10U
#define ST25R3916_REG_NO_RESPONSE_TIMER2                    0x11U
#define ST25R3916_REG_TIMER_EMV_CONTROL                     0x12U
#define ST25R3916_REG_GPT1                                  0x13U
#define ST25R3916_REG_GPT2                                  0x14U
#define ST25R3916_REG_PPON2                                 0x15U
#define ST25R3916_REG_SQUELCH_TIMER      (ST25R3916_SPACE_B|0x0FU)
#define ST25R3916_REG_FIELD_ON_GT        (ST25R3916_SPACE_B|0x15U)

#define ST25R3916_REG_IRQ_MASK_MAIN                         0x16U
#define ST25R3916_REG_IRQ_MASK_TIMER_NFC                    0x17U
#define ST25R3916_REG_IRQ_MASK_ERROR_WUP                    0x18U
#define ST25R3916_REG_IRQ_MASK_TARGET                       0x19U
#define ST25R3916_REG_IRQ_MAIN                              0x1AU
#define ST25R3916_REG_IRQ_TIMER_NFC                         0x1BU
#define ST25R3916_REG_IRQ_ERROR_WUP                         0x1CU
#define ST25R3916_REG_IRQ_TARGET                            0x1DU
#define ST25R3916_REG_FIFO_STATUS1                          0x1EU
#define ST25R3916_REG_FIFO_STATUS2                          0x1FU
#define ST25R3916_REG_COLLISION_STATUS                      0x20U
#define ST25R3916_REG_PASSIVE_TARGET_STATUS                 0x21U

#define ST25R3916_REG_NUM_TX_BYTES1                         0x22U
#define ST25R3916_REG_NUM_TX_BYTES2                         0x23U

#define ST25R3916_REG_NFCIP1_BIT_RATE                       0x24U

#define ST25R3916_REG_AD_RESULT                             0x25U

#define ST25R3916_REG_ANT_TUNE_A                            0x26U
#define ST25R3916_REG_ANT_TUNE_B                            0x27U

#define ST25R3916_REG_TX_DRIVER                             0x28U
#define ST25R3916_REG_PT_MOD                                0x29U
#define ST25R3916_REG_AUX_MOD            (ST25R3916_SPACE_B|0x28U)
#define ST25R3916_REG_TX_DRIVER_TIMING   (ST25R3916_SPACE_B|0x29U)
#define ST25R3916_REG_RES_AM_MOD         (ST25R3916_SPACE_B|0x2AU)
#define ST25R3916_REG_TX_DRIVER_STATUS   (ST25R3916_SPACE_B|0x2BU)

#define ST25R3916_REG_FIELD_THRESHOLD_ACTV                  0x2AU
#define ST25R3916_REG_FIELD_THRESHOLD_DEACTV                0x2BU

#define ST25R3916_REG_REGULATOR_CONTROL                     0x2CU
#define ST25R3916_REG_REGULATOR_RESULT   (ST25R3916_SPACE_B|0x2CU)

#define ST25R3916_REG_RSSI_RESULT                           0x2DU
#define ST25R3916_REG_GAIN_RED_STATE                        0x2EU
#define ST25R3916_REG_CAP_SENSOR_CONTROL                    0x2FU
#define ST25R3916_REG_CAP_SENSOR_RESULT                     0x30U
#define ST25R3916_REG_AUX_DISPLAY                           0x31U

#define ST25R3916_REG_OVERSHOOT_CONF1    (ST25R3916_SPACE_B|0x30U)
#define ST25R3916_REG_OVERSHOOT_CONF2    (ST25R3916_SPACE_B|0x31U)
#define ST25R3916_REG_UNDERSHOOT_CONF1   (ST25R3916_SPACE_B|0x32U)
#define ST25R3916_REG_UNDERSHOOT_CONF2   (ST25R3916_SPACE_B|0x33U)

#ifdef ST25R3916B

#define ST25R3916_REG_AWS_CONF1          (ST25R3916_SPACE_B|0x2EU)
#define ST25R3916_REG_AWS_CONF2          (ST25R3916_SPACE_B|0x2FU)
#define ST25R3916_REG_AWS_TIME1          (ST25R3916_SPACE_B|0x34U)
#define ST25R3916_REG_AWS_TIME2          (ST25R3916_SPACE_B|0x35U)
#define ST25R3916_REG_AWS_TIME3          (ST25R3916_SPACE_B|0x36U)
#define ST25R3916_REG_AWS_TIME4          (ST25R3916_SPACE_B|0x37U)
#define ST25R3916_REG_AWS_TIME5          (ST25R3916_SPACE_B|0x38U)
#define ST25R3916_REG_AWS_RC_CAL         (ST25R3916_SPACE_B|0x39U)
#endif

#define ST25R3916_REG_WUP_TIMER_CONTROL                     0x32U
#define ST25R3916_REG_AMPLITUDE_MEASURE_CONF                0x33U
#define ST25R3916_REG_AMPLITUDE_MEASURE_REF                 0x34U
#define ST25R3916_REG_AMPLITUDE_MEASURE_AA_RESULT           0x35U
#define ST25R3916_REG_AMPLITUDE_MEASURE_RESULT              0x36U
#define ST25R3916_REG_PHASE_MEASURE_CONF                    0x37U
#define ST25R3916_REG_PHASE_MEASURE_REF                     0x38U
#define ST25R3916_REG_PHASE_MEASURE_AA_RESULT               0x39U
#define ST25R3916_REG_PHASE_MEASURE_RESULT                  0x3AU

#if defined(ST25R3916)
#define ST25R3916_REG_CAPACITANCE_MEASURE_CONF              0x3BU
#define ST25R3916_REG_CAPACITANCE_MEASURE_REF               0x3CU
#define ST25R3916_REG_CAPACITANCE_MEASURE_AA_RESULT         0x3DU
#define ST25R3916_REG_CAPACITANCE_MEASURE_RESULT            0x3EU
#elif defined(ST25R3916B)
#define ST25R3916_REG_MEAS_TX_DELAY                         0x3BU
#endif
